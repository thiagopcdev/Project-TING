...
Programa que simula o algoritmo de indexação de documentos similar ao do Google. Ou seja, um programa que permita anexar arquivos de texto e posteriormente opere funções de busca sobre tais arquivos
...
1. Clone the repository
  * `git clone git@github.com:thiagopcdev/Project-TING.git`
2. Enter the repository folder you just cloned:
  * `cd SD-012-PROJECT-TING`
